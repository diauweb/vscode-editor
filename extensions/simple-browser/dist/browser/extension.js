...
var ral_1 = __webpack_require__(3);
...
const simpleBrowserView_1 = __webpack_require__(6);
...
class SimpleBrowserView extends dispose_1.Disposable {
    ...
    static restore(extensionUri, url, webview) {
        return new SimpleBrowserView(extensionUri, url, webview);
    }
    dispose() {
...
const vscode = __webpack_require__(1);
const nls = __webpack_require__(2);
const simpleBrowserManager_1 = __webpack_require__(5);
const simpleBrowserView_1 = __webpack_require__(6);
const localize = nls.loadMessageBundle();

...
const extensionsProposals_1 = __webpack_require__(11);
...
class SettingsDocument {
    ...
    async provideLanguageCompletionItemsForLanguageOverrides(_location, range) {
...
function provideWorkspaceTrustExtensionProposals(existing, range) {
    if (Array.isArray(existing)) {
...
const vscode = __webpack_require__(6);
const nls = __webpack_require__(7);
const settingsDocumentHelper_1 = __webpack_require__(10);
const extensionsProposals_1 = __webpack_require__(11);
const localize = nls.loadMessageBundle();
